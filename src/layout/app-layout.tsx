...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'analyst', 'developer', 'compliance-officer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Wallet', path: '/wallets', entity: 'wallet', service: AccessServiceEnum.PROJECT, icon: FiCreditCard },
