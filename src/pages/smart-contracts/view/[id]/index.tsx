...
import { getSmartContractById } from 'apiSdk/smart-contracts';
...
function SmartContractViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Smart Contract Detail View
          </Text>
          {hasAccess('smart_contract', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/smart-contracts/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('transaction', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/transactions/create?smart_contract_id=${data?.id}`}>
