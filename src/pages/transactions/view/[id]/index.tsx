  ...
  const { data, error, isLoading, mutate } = useSWR<TransactionInterface>(
    ...
    () =>
      getTransactionById(id, {
        relations: ['smart_contract', 'wallet'],
      }),
  );
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Box>
              {hasAccess('smart_contract', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  <Text fontSize="lg" fontWeight="bold" as="span">
                    Smart Contract:
                  </Text>
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/smart-contracts/view/${data?.smart_contract?.id}`}>
